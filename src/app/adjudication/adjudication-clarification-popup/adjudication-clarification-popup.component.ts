  ...
  @Component({
    selector: 'app-adjudication-clarification-popup',
    templateUrl: './adjudication-clarification-popup.component.html',
    styleUrls: ['./adjudication-clarification-popup.component.scss']
  })
  export class AdjudicationClarificationPopupComponent implements OnInit {
    reasons = [];
    otherText = null;
    validationMessage = "";
    adjId = "";
    ...
    constructor(public dialogRef: MatDialogRef<AdjudicationClarificationPopupComponent>,    
    ...
    onSubmit(){
      const payload = {
        adjId: this.adjId,
        rsnTypeCd: this.rsnTypeCd ? this.rsnTypeCd : "SN",
